const Socials = () => {
  return (
    <div className='grid w-full grid-cols-1 grid-rows-3 gap-3 pt-3 mt-3 lg:grid-rows-1 md:grid-rows-1 lg:grid-cols-3 md:grid-cols-3 lg:w-2/3 md:w-full'>
      <article className='flex flex-col items-center justify-center w-full h-full p-6 text-center duration-500 border-2 border-gray-500 rounded shadow-xl cursor-pointer hover:scale-105 dark:bg-neutral-800'>
        ...
        <a
          className='mt-3 text-sm underline cursor-pointer text-red-600 dark:text-red-300 decoration-dotted underline-offset-2'
...
const Headline = () => {
  return (
    <>
      ...
      <p className='text-center text-red-600 dark:text-red-300 text-1xl'>
        Disclaimer: Website is in early development and final website could be
        entirely different.
      </p>
      <p className='text-red-600 dark:text-red-300 text-1xl'>
